...
{
    public class TimeSheetEmployeeBranchResponse
    {
        public string Id { get; set; } = default!;
        public string? TimeSheetBranchId { get; set; } = default!;
        public string? TimeSheetBranchNetworkId { get; set; } = default!;
        public string? TimeSheetBranchWorkModeId { get; set; } = default!;
